define(function (require) {
    return [
        {//01
            ...
            'datos'     : [ { 'dato' : 'José 90 metros.' }, { 'dato' : 'Sofía 56 metros.' } ],
            'operacion' : [ '90', '+', '56', '=', '146' ],
            'respuesta' : 'Tienen 146 metros entre los dos.',
            'resp_num'  : '146',
            'signo'     : '+'
        },
        {//02
            ...
            'datos'     : [ { 'dato' : '18 metros de tela.' }, { 'dato' : '24 metros de tela.' } ],
            'operacion' : [ '18', '+', '24', '=', '42' ],
            'respuesta' : 'Ha comprado 42 metros de tela.',
            'resp_num'  : '42',
            'signo'     : '+'
        },
        {//03
            ...
            'datos'     : [ { 'dato' : '60 yardas primer día.' }, { 'dato' : '62 yardas el segundo día.' }, { 'dato' : '65 yardas el tercer día.' } ],
        ...
        {//04
            ...
            'datos'     : [ { 'dato' : '1,720 metros.' }, { 'dato' : '325 metros.' } ],
            'operacion' : [ '1,720', '-', '325', '=', '1,395' ],
            'respuesta' : 'Le queda por recorrer 1,395 metros.',
            'resp_num'  : '1,395',
            'signo'     : '-'
        },
        {//05
            ...
            'datos'     : [ { 'dato' : '12 tramos.' }, { 'dato' : '20 metros cada uno.' } ],
            'operacion' : [ '12', '*', '20', '=', '240' ],
            'respuesta' : 'Han construido 240 metros.',
            'resp_num'  : '240',
            'signo'     : '*'
        },
        {//06
            ...
            'datos'     : [ { 'dato' : '9 kilómetros.' }, { 'dato' : '3 veces más.' } ],
            'operacion' : [ '9', '*', '3', '=', '27' ],
        ...
        {//07
            ...
            'datos'     : [ { 'dato' : '32 centímetros.' }, { 'dato' : '17 veces.' } ],
            'operacion' : [ '17', '*', '32', '=', '544' ],
        ...
        {//08
            ...
            'datos'     : [ { 'dato' : '2 yardas de tela.' }, { 'dato' : '11 titulares.' } ],
            'operacion' : [ '11', '*', '2', '=', '22' ],
            'respuesta' : 'Necesita 22 yardas de tela.',
            'resp_num'  : '22',
            'signo'     : '*'
        },
        {//09
        ...
        {//10
            ...
            'datos'     : [ { 'dato' : '10 pisos.' }, { 'dato' : '5 metros.' } ],
            'operacion' : [ '10', '*', '5', '=', '50' ],
        ...
        {//11
            ...
            'datos'     : [ { 'dato' : '100 centímetros.' }, { 'dato' : '60 metros.' } ],
        ...
        {//12
            ...
            'datos'     : [ { 'dato' : '621 metros.' }, { 'dato' : '3 jardines.' } ],
            'operacion' : [ '621', '/', '3', '=', '207' ],
            'respuesta' : 'Corresponden 207 metros.',
            'resp_num'  : '207',
            'signo'     : '/'
        },
        {//13
            ...
            'datos'     : [ { 'dato' : '9 centímetros.' }, { 'dato' : '3 trozos.' } ],
            'operacion' : [ '9', '/', '3', '=', '3' ],
            'respuesta' : 'Cada trozo mide 3 centímetros.',
            'resp_num'  : '3',
            'signo'     : '/'
        },
        {//14
            ...
            'datos'     : [ { 'dato' : '249 kilómetros.' }, { 'dato' : '3 horas.' } ],
            'operacion' : [ '249', '/', '3', '=', '83' ],
            'respuesta' : 'Recorrerá 83 kilómetros.',
            'resp_num'  : '83',
            'signo'     : '/'
        }
    ];
