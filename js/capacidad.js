define(function (require) {
    return [
        ...
        },
        {
            ...
            'datos'     : [ '50 litros', '2 litros' ],
            'operacion' : [ '50', '/', '2', '=', '50' ],
            'respuesta' : 'Puedo llanar 50 botellas.',
            'resp_num'  : '50',
            'signo'     : '/'
        },
        {
        ...
        },
        {
            ...
            'datos'     : [ '25 barriles', '8 litros' ],
            'operacion' : [ '25', '*', '8', '=', '200' ],
            'respuesta' : 'Hay 200 litros.',
            'resp_num'  : '200',
            'signo'     : '*'
        },
        {
            ...
            'datos'     : [ '30 dias', '4 personas','8 litros' ],
            'operacion' : [ '30', '*', '4', '*','8','=', '960' ],
            'respuesta' : 'Gastará 960 litros.',
            'resp_num'  : '960',
            'signo'     : '*'
        },
        {
            'ejercicio' : '¿Cuántos cuartos de litro necesitamos para llenar un depósito de 6 litros?',
            'datos'     : [ '6 litros', '0.25 litros'],
            'operacion' : [ '6', '/', '0.25','=', '24' ],
            'respuesta' : 'Necesitamos 24 cuartos.',
            'resp_num'  : '24',
            'signo'     : '/'
        },
        {
