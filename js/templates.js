define(function (require) {
    return [
        ...
        {'template' : '<div id="page2"> <h1 class="object" id="tema">{{tema}}</h1> <p class="object" id="concepto"><b>{{concepto}}</b></p> <p class="object" id="ejemplo"><b>{{ejemplo}}</b></p><button type="button" id="btn_sig" class="pantalla_2 object" data="3" target="{{id}}"></button><button type="button" class="object" id="pantalla_0" data="1"></button>  </div>'},
