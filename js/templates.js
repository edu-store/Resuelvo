define(function (require) {
    return [
        ...
        {'template' : '<div id="page3"> <div class="panel object" id="problema-panel"> <p class="object" id="problema">{{ejercicio}}</p> </div> <div class="panel object" id="datos-panel"> <label class="object" id="datos-label">Datos</label> <div id="datos"> {{#datos}}<input type="text" class="object dato"/>{{/datos}} </div> </div> <div class="object" id="signos"> <h1>+</h1> <h1>-</h1> <h1>x</h1> <h1>/</h1> </div> <div class="panel object" id="operacion-panel"> <label class="object" id="operacion-label">Operación</label> <div id="operacion"> {{#operacion}}<input class="object operacion"/>{{/operacion}} </div> </div> <div class="panel object" id="respuesta-panel"> <label class="object" id="respuesta-label">Respuesta</label> <input type="text" class="object" id="respuesta"/> <button type="button" class="object" id="btn_rv" >REVISAR</button> </div> <div class="object" id="cont_btn_ini"> <button type="button" class="object" id="btn_ini" data="1">INICIO</button> </div> <div class="object" id="cont_btn_nv"> <button type="button" class="object" id="btn_nv">NUEVO</button> </div>'}
    ];
});
