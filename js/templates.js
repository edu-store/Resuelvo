...
<<<<<<< HEAD
        {'template' : '<div id="page1"> </div> <h1 id="titulo" class="object">RESUELVO</h1> {{#topics}}<button type="button" id="{{id}}" class="pantalla_1 object" data="2">{{nombre}}</button> <br/> {{/topics}} </div>'},
=======
...
>>>>>>> ec8cdc2e9a6a479046253e0edc3f2375509b9de0
