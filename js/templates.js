    ...
    return [
        {
            'content'  : {
                ...
                'concepts' : [
                    { 'tema' : 'Números Naturales', 'concepto' : 'Son aquellos símbolos que nos permiten representar la cantidad de elementos que tiene un conjunto.', 'ejemplo' : '1, 2, 3, 4', 'id' : 'btn_nn' },
